...
const copy = {
  en: {
    ...
    heroRole: "Creative Technologist / Technical Director",
    heroCapabilities: "3D · VFX · AI · Creative Technology",
    heroWork: "Creative Work",
    scrollPrompt: "Scroll to explore",
    heroBriefLabel: "Profile / Capabilities",
    heroBrief: "Creative Technologist and Technical Director working across 3D, VFX and AI-assisted production, with hands-on experience in editing, graphics and retouching, and direct coordination between creative teams, clients and agencies.",
    ...
    framebreedSummary: [
      "Technical Director with a background in technical 3D work, coordinating teams, clients and agencies while supporting estimates, deliverables, editing, graphics, AI workflows, 3D and on-set VFX supervision.",
    ],
    present: "Present",
  ...
  ro: {
    ...
    heroRole: "Creative Technologist / Director tehnic",
    heroCapabilities: "3D · VFX · AI · Tehnologie creativă",
    heroWork: "Creative Work",
    scrollPrompt: "Derulează pentru a explora",
    heroBriefLabel: "Profil / Competențe",
    heroBrief: "Creative Technologist și Director tehnic activ în 3D, VFX și producție asistată de AI, cu experiență hands-on în editare, grafică și retuș, precum și coordonare directă între echipe creative, clienți și agenții.",
    ...
    framebreedSummary: [
      "Director tehnic cu experiență în 3D tehnic, coordonând echipe, clienți și agenții și contribuind la estimări, livrabile, editare, grafică, fluxuri AI, 3D și supervizare VFX pe platou.",
    ],
    present: "Prezent",
